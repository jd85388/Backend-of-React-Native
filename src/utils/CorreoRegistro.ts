...
export const enviarCorreoRegistro = async (
  ...
  // Corrige el nombre de la variable de entorno
  const link = `${process.env.FRONTEND}/confirmar/${token}`;

  // Cambia estas rutas por URLs públicas reales
  const logoUrl = "https://tudominio.com/assets/logo.png";
      ...
      <tr>
        <td align="center">
          <table width="600" cellpadding="0" cellspacing="0" border="0"
            ...
            <!-- CABECERA -->
            <tr>
              <td align="center" style="background:linear-gradient(90deg,#12c3f0,#0e7fc0);padding:30px;">
                <img src="${logoUrl}" alt="Life Reminder" width="120" style="display:block;margin-bottom:20px;">
                <h1 style="color:#fff;margin:0;font-size:26px;font-weight:bold;">
                  ¡BIENVENIDO A LIFE REMINDER,
                </h1>
                <h2 style="color:#fff;margin:0;font-size:22px;font-weight:400;">${nombre} ☻</h2>
              </td>
            </tr>
            ...
            <tr>
              <td style="padding:30px;color:#333;">
                ...
                <p style="font-size:12px;color:#777;text-align:center;">
                  ...
                  <a href="${link}" style="color:#12c3f0;">${link}</a>
                </p>
              </td>
            </tr>
            ...
            <!-- CONTACTO -->
            <tr>
              <td style="background:#f0f9fc;padding:25px;">
                <h3 style="color:#0e7fc0;text-align:center;margin-top:0;">CONTÁCTANOS:</h3>
