...
export const crearMedicamentoController = async (req: Request, res: Response) => {
  try {
...
export const obtenerMedicamentosController = async (req: Request, res: Response) => {
  try {
...
export const eliminarMedicamentoController = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
