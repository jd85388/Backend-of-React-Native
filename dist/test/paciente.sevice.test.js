...
describe('service: crearPaciente', () => {
    ...
    it('debe lanzar error si falta algun campo', async () => {
        ...
        await expect(crearPaciente(datosIncompletos))
            .rejects
    ...
    it('debe crear un paciente correctamente con todos los campos validados', async () => {
        ...
        expect(envioCorreoRegistro).toHaveBeenCalledWith(datosCompletos.email, datosCompletos.nombre, 'mocked_jwt_token');
    });
});
